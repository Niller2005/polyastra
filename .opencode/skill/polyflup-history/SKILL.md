...
### 2026-01-07
- **Feature Removal (User Request)**: Removed automatic USDC allowance/approval logic and auto-claim (winnings redemption) to prevent unnecessary on-chain transactions and gas fee issues.
