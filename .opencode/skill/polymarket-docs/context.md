# Polymarket API Documentation - Full Reference

This file contains the complete Polymarket API documentation for comprehensive context.
...
1. **API Endpoints**: All REST API endpoints for CLOB, Gamma, Data API
2. **WebSocket Channels**: Real-time data streaming protocols
3. **Authentication**: L1/L2 authentication flows and API credentials
4. **Order Management**: Creating, canceling, and monitoring orders
5. **Market Data**: Fetching markets, prices, orderbooks, historical data
6. **Builder Program**: Integration guide for builders and applications
7. **CTF Operations**: Token splitting, merging, and redemption
8. **Fee Structure**: Maker rebates and taker fees
9. **Rate Limits**: API rate limiting by tier and endpoint type
10. **Geographic Restrictions**: Countries where Polymarket is blocked

Use this documentation to answer any questions about Polymarket's trading APIs, integration patterns, or technical specifications.
